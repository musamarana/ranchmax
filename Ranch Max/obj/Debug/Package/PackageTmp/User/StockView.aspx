...
<asp:Content ID="Content1" ContentPlaceHolderID="NestedMaster" runat="server">
      ...
      <style>
        .gvStockEditRow input[type=text]{width:50px;}
        .gvStockEditRow select{width:50px;}
         </style>
...
<%--                         <asp:TextBox ID="txtUName" Text= '<%#Eval("UserName") %>'  runat="server"></asp:TextBox><br />--%>
                    ...
                    style="font-size:18px;"></asp:RequiredFieldValidator>
                     ...
                     <%--Total Bags--%>
                     <asp:TemplateField HeaderText="Total Bags/Packs">
<%--                        <HeaderTemplate>Emp_ID</HeaderTemplate>--%>
                        <ItemTemplate>
                    ...
                    <%--bagsize--%>
                     <asp:TemplateField HeaderText="Bag/Pack Size">
<%--                        <HeaderTemplate>Emp_ID</HeaderTemplate>--%>
                        <ItemTemplate>
...
<%--                        <HeaderTemplate>Emp_ID</HeaderTemplate>--%>
                        ...
                        <EditItemTemplate>
                         <asp:TextBox ID="txtAmount" Text= '<%#Eval("Amount") %>'  runat="server"></asp:TextBox><br />
