<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeBehind="FeedConsumption.aspx.cs" Inherits="Ranch_Max.FeedConsumption1" %>
    ...
    <div id="addFeed">
        ...
        <ContentTemplate>
            <table class="table table-borderless">
                ...
                <%--formula name--%>
                 <tr>
                <td style="width: 197px"><asp:Label ID="Label1" runat="server" Text="Formula Name" style="color:#6D7FCC; 
                font-size:18px;"></asp:Label></td>
                <td class="auto-style3">
                    <asp:DropDownList ID="ddFormula" Width="180px" runat="server" AutoPostBack="true" >
...
<%--                <td class="auto-style2">&nbsp;</td>--%>
                    ...
                    ErrorMessage="Required." ControlToValidate="ddFormula" InitialValue="--Select--" ForeColor="Red" 
                    style="font-size:18px;"></asp:RequiredFieldValidator></td>
            </tr>
                
                <%--Animal breed--%>
                <tr>
                <td style="width: 197px"><asp:Label ID="Label4" runat="server" Text="Animal Breed" style="color:#6D7FCC; 
                font-size:18px;"></asp:Label></td>
                <td class="auto-style3">
                    <asp:DropDownList ID="ddBreed" Width="180px" runat="server" AutoPostBack="true" >
<%--                        <asp:ListItem Text="Select Feed" Value="0"></asp:ListItem>--%>
                    </asp:DropDownList></td>
<%--                <td class="auto-style2">&nbsp;</td>--%>
                ...
                <%--Username--%>
                    <tr>
                <td style="width: 197px"><asp:Label ID="Label2" runat="server" Text="User" style="color:#6D7FCC; 
                font-size:18px;"></asp:Label></td>
                <td class="auto-style3">
...
<%--                <td class="auto-style2">&nbsp;</td>--%>
                ...
                <%--Slot--%>
                <tr>
                <td style="width: 197px"><asp:Label ID="Label8" runat="server" Text="Slot" style="color:#6D7FCC; font-size:18px;"></asp:Label></td>
                <td class="auto-style3"><asp:DropDownList ID="ddSlot" Width="180px" runat="server" AutoPostBack="true" >
