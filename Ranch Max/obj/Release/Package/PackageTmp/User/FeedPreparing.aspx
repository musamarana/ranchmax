<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeBehind="FeedPreparing.aspx.cs" Inherits="Ranch_Max.FeedPreparing1" %>
    ...
    <div id="addFeed">
        ...
        <ContentTemplate>
            <table class="table table-borderless">
                 ...
                 <tr>
                <td style="width: 197px"><asp:Label ID="Label1" runat="server" Text="Formula" style="color:#6D7FCC; 
...
<%--                <td class="auto-style2">&nbsp;</td>--%>
                ...
                <tr>
                <td style="width: 197px"><asp:Label ID="Label4" runat="server" Text="Item" style="color:#6D7FCC; 
                font-size:18px;"></asp:Label></td>
                <td class="auto-style3">
                    <asp:DropDownList ID="ddItem" Width="180px" runat="server" AutoPostBack="true" >
<%--                        <asp:ListItem Text="Select Feed" Value="0"></asp:ListItem>--%>
                    </asp:DropDownList></td>
<%--                <td class="auto-style2">&nbsp;</td>--%>
                      <td class="auto-style2"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                    ErrorMessage="Required." ControlToValidate="ddItem" InitialValue="--Select--" ForeColor="Red" 
                    style="font-size:18px;"></asp:RequiredFieldValidator></td>
            </tr>

                
                <tr>
                <td style="width: 197px"><asp:Label ID="Label2" runat="server" Text="Quantity" style="color:#6D7FCC; font-size:18px;"></asp:Label></td>
