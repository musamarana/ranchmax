...
<%--                <td class="auto-style2">&nbsp;</td>--%>
      ...
      <br />
        ...
        <div style="margin-left:150px ; font-family:Arial" >
            <asp:GridView ID="gvRole" runat="server" CellPadding="3"  Width="500px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" >
