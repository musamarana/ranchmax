<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeBehind="StockType.aspx.cs" Inherits="Ranch_Max.StockType1" %>
 ...
 <style>
    ...
    <div id="addFeed">
        ...
        <ContentTemplate>
            ...
            <tr>
                <td style="width: 197px"><asp:Label ID="Label1" runat="server" Text="Type Name" style="color:#6D7FCC; font-size:18px;"></asp:Label></td>
                <td class="auto-style3"><asp:TextBox ID="txttype" runat="server" style="border-radius:10px;" AutoPostBack="true"></asp:TextBox></td>
                <td class="auto-style2"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                    ErrorMessage="Required." ControlToValidate="txttype" ForeColor="Red" 
    ...
    <asp:GridView ID="gvStock" runat="server" AutoGenerateColumns="False"  class="table" AllowSorting="True" 
             DataKeyNames="StockType_Id" CellPadding="5" CellSpacing="1" OnRowDeleting="gvStock_RowDeleting"
    ...
    <Columns>
                     ...
                     <asp:TemplateField HeaderText="Type Name">
                         <ItemTemplate>
                           <asp:Label Text= '<%#Eval("TypeName") %>' runat="server"/>

                        </ItemTemplate>
                        <EditItemTemplate>
                         <asp:TextBox ID="txttype" Text= '<%#Eval("TypeName") %>'  runat="server"></asp:TextBox><br />
