<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeBehind="StockItem.aspx.cs" Inherits="Ranch_Max.StockItem1" %>
        ...
        <ContentTemplate>
            <table class="table table-borderless">
                ...
                <td class="auto-style3">
                    <asp:DropDownList ID="ddSType" Width="180px" runat="server" AutoPostBack="true" >
...
<%--                <td class="auto-style2">&nbsp;</td>--%>
                    ...
                    ErrorMessage="Required." ControlToValidate="ddSType" InitialValue="--Type--" ForeColor="Red" 
                    style="font-size:18px;"></asp:RequiredFieldValidator></td>
            </tr>
                <%--Itme Name  --%>

                <tr>
                <td style="width: 197px"><asp:Label ID="Label2" runat="server" Text="Item Name" style="color:#6D7FCC; font-size:18px;"></asp:Label></td>
                <td class="auto-style3"><asp:TextBox ID="txtIName" runat="server" style="border-radius:10px;" AutoPostBack="true"></asp:TextBox></td>
                <td class="auto-style2"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                    ErrorMessage="Required." ControlToValidate="txtIName" ForeColor="Red" 
                    style="font-size:18px;"></asp:RequiredFieldValidator></td>
            </tr>
                 
                <%--Brand Name  --%>
                <tr>
                <td style="width: 197px"><asp:Label ID="Label3" runat="server" Text="Brand" style="color:#6D7FCC; font-size:18px;"></asp:Label></td>
                <td class="auto-style3"><asp:TextBox ID="txtBrand" runat="server" style="border-radius:10px;" AutoPostBack="true"></asp:TextBox></td>
               <%-- <td class="auto-style2"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                    ErrorMessage="Required." ControlToValidate="txtIName" ForeColor="Red" 
                    style="font-size:18px;"></asp:RequiredFieldValidator></td>--%>
            </tr>
